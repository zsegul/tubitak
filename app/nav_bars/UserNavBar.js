...
const UserNavbar = ({ years, months, days, mentor}) => {
      ...
      <AppBar position="static" sx={{ backgroundColor: 'white', color: 'black' }}>
        <Toolbar>
          <Box sx={{ display: 'flex', alignItems: 'center', marginRight: '10px' }}>
            ...
            <Box sx={{ backgroundColor: 'lightgray', height: 32, width: 3, marginLeft: '20px' }} />
          </Box>
          <Typography variant="h6" sx={{ flexGrow: 1, fontWeight: 'bold', marginLeft: '20px' }}>
          ...
          <Box sx={{ flexGrow: 0 , display: 'flex', alignItems: 'center', marginLeft: 0 }}>
            ...
            <Typography variant="body1" sx={{ marginLeft: 1, fontWeight: 'bold', fontSize: '14px'}}>
              {fullName}
            </Typography>
