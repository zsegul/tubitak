...
const UserInfoForm = ({ newAvatar, setNewAvatar, isNewAvatarUploaded, setIsNewAvatarUploaded, avatar, selectedFile, setSelectedFile, formData, setFormData }) => {
        ...
        <Card sx={{ borderRadius: '10px', borderBottom: '4px solid red !important', border: '2px solid lightgray', marginTop: '20px', marginLeft: '15px', marginRight: '15px',marginBottom: '20px'}}>
            ...
            <Box direction='row' sx={{padding: '10px', display: 'flex', alignItems: 'center'}}>
                ...
                <IconButton sx={{ height: '100%' }} onClick={handleModalOpen}>
                    {onScreenAvatar && <Avatar src={onScreenAvatar} alt="User Avatar" sx={{ width: avatarSize, height: avatarSize }} />}
                </IconButton>
            ...
            <Box sx={{ margin: '10px'}}>
                <Grid container spacing={'20px'}>
                    ...
                    <Grid item xs={12} md={6}>
                        <TextField
                            disabled={editableFields.tcKimlikNo}
                            fullWidth
                    ...
                    <Grid item xs={12} md={6}>
                        <TextField
                            disabled={editableFields.cinsiyet}
                            fullWidth
                            label="Cinsiyet"
                    ...
                    <Grid item xs={12} md={6}>
                        <TextField
                            disabled={editableFields.akademikUnvan}
                            fullWidth
